...
final class MessageCellViewTests: XCTestCase {
    ...
    func testConfigure() throws {
        ...
        cell.configure(message: "Test message")
        
        XCTAssertEqual(cell.messageText.text, "Test message")
    }
}
